...
- Do not try to run any script if not mentioned.
- Keep the changes simple and minimal as much as possible. 
- Do not over engineer things, just do what you have asked to do. 
- Play everything before you make any changes. 